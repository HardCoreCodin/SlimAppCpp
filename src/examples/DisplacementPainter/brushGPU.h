...
__global__ void d_run(u32 width, u32 height, u32 pixel_count, RectI relevant_bounds, ParticleBrush brush, bool displace,
...
void runOnGPU(const Image &image, const Image &current, vec2 *displacement_map, const RectI &relevant_bounds, ParticleBrush &brush, bool displace) {
    ...
    d_run<<<blocks, threads>>>(image.width, image.height, pixel_count, relevant_bounds, brush, displace,
